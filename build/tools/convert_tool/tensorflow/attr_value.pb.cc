...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_AttrValue_attr_5fvalue_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_AttrValue_attr_5fvalue_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_attr_5fvalue_2eproto = {
  false, false, descriptor_table_protodef_attr_5fvalue_2eproto, "attr_value.proto", 837,
...
static bool dynamic_init_dummy_attr_5fvalue_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_attr_5fvalue_2eproto)), true);
namespace tensorflow {
