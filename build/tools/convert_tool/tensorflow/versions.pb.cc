...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_VersionDef_versions_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_VersionDef_versions_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_versions_2eproto = {
  false, false, descriptor_table_protodef_versions_2eproto, "versions.proto", 162,
...
static bool dynamic_init_dummy_versions_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_versions_2eproto)), true);
namespace tensorflow {
